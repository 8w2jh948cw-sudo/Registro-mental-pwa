...
(function loadOptimizedEngines(){
  ...
  const start=async()=>{
    try{await load('./v04c19.js?v=0.4.19','performance')}catch{}
    const emotion=load('./v04c12.js?v=0.4.19','emotion');
    const palette=load('./v04c15.js?v=0.4.19','semantic-palette');
    const icons=load('./v04c16.js?v=0.4.19','record-icons');
    ...
    await Promise.resolve(emotion).then(()=>load('./v04c18.js?v=0.4.19','visual')).catch(()=>{});
    try{if(typeof rmInstallPerformanceRuntime==='function')rmInstallPerformanceRuntime()}catch{}
    try{await load('./v04c20.js?v=0.4.19','visual-mode')}catch{}
    try{if(typeof rmInstallPerformanceRuntime==='function')rmInstallPerformanceRuntime()}catch{}

    await idle();
    const learning=load('./v04c11.js?v=0.4.19','learning');
    await Promise.allSettled([learning]);
    try{if(typeof rmInstallPerformanceRuntime==='function')rmInstallPerformanceRuntime()}catch{}
    const continuity=Promise.resolve(learning).then(()=>load('./v04c13.js?v=0.4.19','continuity'));
    await Promise.allSettled([continuity]);
    try{if(typeof rmInstallPerformanceRuntime==='function')rmInstallPerformanceRuntime()}catch{}
    await Promise.resolve(continuity).then(()=>load('./v04c14.js?v=0.4.19','interview')).catch(()=>{});
    try{if(typeof rmInstallPerformanceRuntime==='function')rmInstallPerformanceRuntime()}catch{}
  };
  start();
})();
